...
begin
  try
    ...
    RESTResponse.JSONValue.TryGetValue('id', oUser.id);
    RESTResponse.JSONValue.TryGetValue('name', oUser.name);
    RESTResponse.JSONValue.TryGetValue('birthday', oUser.birthday);
    RESTResponse.JSONValue.TryGetValue('gender', oUser.gender);
    RESTResponse.JSONValue.TryGetValue('email', oUser.email);
    oUser.picture := 'http://graph.facebook.com/' + oUser.id + '/picture?type=large';
